...
This is the implementation of a Splitwise clone application built with Node.js. It provides client and server-side functionality for managing groups, transactions, and settlements between users.
